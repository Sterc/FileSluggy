...
$_lang['setting_filesluggy.guid_use_desc'] = 'If \'Yes\' add an unique ID as a prefix (added after the filename_prefix) or suffix.';
$_lang['setting_filesluggy.guid_location'] = "Unique ID Location";
$_lang['setting_filesluggy.guid_location_desc'] = 'Define if the unique ID should be added as a \'prefix\' (default) or \'suffix\'.';
